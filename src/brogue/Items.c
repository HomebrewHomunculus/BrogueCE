...
void itemDetails(char *buf, item *theItem) {
    ...
    // Brogue Lite:
    // Removed descriptions for mercy and duplication runics
                        ...
                        if (theItem->enchant2 == W_SLAYING) {
                            ...
                            if ((theItem->flags & ITEM_IDENTIFIED) || rogue.playbackOmniscience) {
                                switch (theItem->enchant2) {
                                    ...
                                    // Brogue Lite note:
                                    // Removed (commented out) case for W_MERCY.
                ...
                if (theItem->flags & ITEM_RUNIC) {
                    if ((theItem->flags & ITEM_RUNIC_IDENTIFIED) || rogue.playbackOmniscience) {
                        ...
                        switch (theItem->enchant2) {
                            ...
                            // Brogue Lite note:
                            // Removed (commented out) cases for negative armor runics
...
//          }
    ...
    if ((theItem->category & POTION) && (hitSomethingSolid || !cellHasTerrainFlag(x, y, T_AUTO_DESCENT))) {
        if (theItem->kind == POTION_CONFUSION || theItem->kind == POTION_POISON
            ...
            // Brogue Lite note:
            // No more need to identify hallucination potion when it splashes harmlessly.
...
void readScroll(item *theItem) {
    ...
    switch (theItem->kind) {
        // Brogue Lite note:
        // Removed case for SCROLL_IDENTIFY.
        ...
        // Brogue Lite note:
        // Removed (commented out) case for SCROLL_REMOVE_CURSE.
        ...
        // Brogue Lite note:
        // Removed cases for SCROLL_AGGRAVATE_MONSTER and SCROLL_SUMMON_MONSTER
...
void drinkPotion(item *theItem) {
    ...
    switch (theItem->kind) {
        ...
        // Brogue Lite note:
        // Removed case for POTION_HALLUCINATION.
...
short magicCharDiscoverySuffix(short category, short kind) {
    ...
    switch (category) {
        case SCROLL:
            switch (kind) {
                // Brogue Lite note:
                // Removed cases for SCROLL_AGGRAVATE_MONSTER, SCROLL_SUMMON_MONSTER.
